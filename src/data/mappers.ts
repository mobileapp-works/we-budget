...
export function toExpense(r: Row): Expense {
  return {
    ...
    currency: r.currency,
    exchangeRate: r.exchange_rate === null || r.exchange_rate === undefined ? 1 : Number(r.exchange_rate),
    baseAmount: r.base_amount === null || r.base_amount === undefined ? Number(r.amount) : Number(r.base_amount),
